        ...
        <div className="card">
          ...
          <div style={{ marginTop: '24px', paddingTop: '16px', borderTop: '1px solid #eee' }}>
            <div style={{ backgroundColor: '#f8f9fa', padding: '12px', borderRadius: '4px', marginBottom: '16px' }}>
              <p style={{ fontSize: '12px', color: '#495057', margin: '0 0 8px 0', fontWeight: '500' }}>
                Demo Credentials:
              </p>
              <div style={{ fontSize: '11px', color: '#6c757d', lineHeight: '1.4' }}>
                <div><strong>Admin:</strong> admin@campus.edu</div>
                <div><strong>Organizer:</strong> organizer@demo.com</div>
                <div><strong>Student:</strong> student@demo.com</div>
                <div style={{ marginTop: '4px', fontStyle: 'italic' }}>Use any password</div>
              </div>
            </div>
